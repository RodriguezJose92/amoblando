class MudiExperience{
    ...
    createBtns(){
        ...
        <?xml version="1.0" encoding="UTF-8"?>
            <svg id="img3DBtn" class="btnMudi3D imgBtn3D" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 360">
                <defs>
                    <style>
                        .cls-1{
                            fill:${this.color};
        ...
        modalMudi.innerHTML=`
            <div class="iframeMudi3D">
                ...
                <div class="containerBtnsActions">
                    ...
                    <rect class="cls-1_modal imgBtnAR" x="9.52" y="9" width="292.07" height="87" rx="40" ry="40"/>
